...
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.domain.OrderSide;
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.domain.OrderType;
...
public interface BinanceApiService {
  ...
  Call<WithdrawResponse> withdraw(@Query("asset") String asset, @Query("address") String address, @Query("addressTag") String addressTag, @Query("amount") String amount, @Query("name") String name,
                                  @Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);
  ...
  Call<AssetDetail> getAssetDetail(@Query("recvWindow") Long recvWindow, @Query("timestamp") Long timestamp);
