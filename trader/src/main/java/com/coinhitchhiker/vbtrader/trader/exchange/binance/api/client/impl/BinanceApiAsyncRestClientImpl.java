...
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.BinanceApiAsyncRestClient;
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.constant.BinanceApiConstants;
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.BinanceApiCallback;
...
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.domain.event.ListenKey;
...
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.domain.general.ServerTime;
...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
  ...
  @Override
  public void withdraw(String asset, String address, String addressTag, String amount, String name, long recvWindow, long timestamp, BinanceApiCallback<WithdrawResponse> callback) {
    binanceApiService.withdraw(asset, address, addressTag, amount, name, recvWindow, timestamp)
        .enqueue(new BinanceApiCallbackAdapter<>(callback));
  }
  ...
  @Override
  public void getDepositAddress(String asset, long recvWindow, long serverTime, BinanceApiCallback<DepositAddress> callback) {
    binanceApiService.getDepositAddress(asset, recvWindow, serverTime)
        .enqueue(new BinanceApiCallbackAdapter<>(callback));
  }

  @Override
  public void getAssetDetail(long recvWindow, long serverTime, BinanceApiCallback<AssetDetail> callback) {
    binanceApiService.getAssetDetail(recvWindow, serverTime)
        .enqueue(new BinanceApiCallbackAdapter<>(callback));
  }
