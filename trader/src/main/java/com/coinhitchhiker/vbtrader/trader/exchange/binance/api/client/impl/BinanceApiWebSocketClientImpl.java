...
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.BinanceApiWebSocketClient;
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.constant.BinanceApiConstants;
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.domain.event.*;
import com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client.domain.market.CandlestickInterval;
...
public class BinanceApiWebSocketClientImpl implements BinanceApiWebSocketClient, Closeable {
    ...
    public BinanceApiWebSocketClientImpl() {
        ...
        this.client = new OkHttpClient.Builder().connectTimeout(1L, TimeUnit.SECONDS).dispatcher(d).build();
    }
