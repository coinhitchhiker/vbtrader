package com.coinhitchhiker.vbtrader.trader.exchange.binance.api.client;
...
public interface BinanceApiAsyncRestClient {
   ...
   * @param addressTag addressTag to withdraw to
   * @param amount amount to withdraw
   * @param name description/alias of the address
   */
  void withdraw(String asset, String address, String addressTag, String amount, String name, long recvWindow, long timestamp, BinanceApiCallback<WithdrawResponse> callback);
   ...
   */
   void getDepositAddress(String asset, long recvWindow, long serverTime, BinanceApiCallback<DepositAddress> callback);

  /**
   * Fetch asset detail.
   *
   * @param callback the callback that handles the response and returns the asset detail
   */
  void getAssetDetail(long recvWindow, long serverTime, BinanceApiCallback<AssetDetail> callback);
