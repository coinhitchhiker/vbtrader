...
public interface BinanceApiRestClient {
   ...
   * be sent AND the distance between <code>startTime</code> and <code>endTime</code> must be less
   * than 24 hours.
   *
   ...
   */
  List<Trade> getMyTrades(String symbol, Integer limit, Long fromId, Long recvWindow,
                          Long timestamp);
   ...
   */
  WithdrawResponse withdraw(String asset, String address, String addressTag, String amount, String name);
   ...
   * @param name description/alias of the address
   */
  WithdrawResponse withdraw(String asset, String address, String addressTag, String amount, String name, Long recvWindow,
                            Long timestamp);
   ...
   */
  DepositAddress getDepositAddress(String asset, long recvWindow, long serverTime);
   ...
   * @return asset detail.
   */
  AssetDetail getAssetDetail(long recvWindow, long serverTime);
